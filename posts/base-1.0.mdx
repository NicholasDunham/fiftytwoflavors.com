...
and herbs. It's emulsified using two egg yolks, which is enough to give it a
smooth texture without making it taste eggy.
...
cooked flavor. However, because of the low cooking temperature, many popular ice
cream stabilizers like locust bean gum don't work well with this recipe.
Instead, I use a combination of <CMC />, guar gum, and lambda carrageenan. You
can omit the stabillizers if you like, but the texture will be slightly less
smooth. If you prefer to use a different combination of stabilizers, you may
need to adjust the cooking temperature.
